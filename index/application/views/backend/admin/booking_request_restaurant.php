                ...
                <div class="bs-example">
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-blue" role="menu">
                      <li>
                        <?php if($expired_date >= strtotime(date('dMY'))){ ?>
                          <?php if($booking['status'] == 0){ ?>
                            <a href="<?php echo site_url('admin/booking_request_restaurant/approved/'.$booking['id']); ?>" class="">
                              <i class="entypo-check"></i>
                              <?php echo get_phrase('approve'); ?>
                            </a>
                          <?php }else{ ?>
                            <a href="<?php echo site_url('admin/booking_request_restaurant/pending/'.$booking['id']); ?>" class="">
                              <i class="entypo-check"></i>
                      ...
                      <li>
                        <a href="#" class="" onclick="confirm_modal('<?php echo site_url('admin/booking_request_restaurant/delete/'.$booking['id']); ?>');">
